...
func PopulateLabels(lb *labels.Builder, cfg *config.ScrapeConfig, noDefaultPort bool, tlset, tgLabels model.LabelSet) (res labels.Labels, err error) {
	PopulateDiscoveredLabels(lb, cfg, tlset, tgLabels)
...
func TargetsFromGroup(tg *targetgroup.Group, cfg *config.ScrapeConfig, noDefaultPort bool, targets []*Target, lb *labels.Builder) ([]*Target, []error) {
	...
	for i, tlset := range tg.Targets {
		lset, err := PopulateLabels(lb, cfg, noDefaultPort, tlset, tg.Labels)
		if err != nil {
